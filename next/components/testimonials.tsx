      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">お客様の声</h2>
            <p className="text-xl text-gray-400">受験・学習を通して、お子さんが力強くしなやかに社会を生き抜いていく力を身に着けられるよう、お子さんの大切な時間を、私達にお預けいただけませんでしょうか？</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
              ...
              <blockquote className="text-lg text-gray-400 grow">— ３ヶ月で学習習慣が定着しました。いちばん大事なところを教えてもらえた。</blockquote>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="200">
              ...
              <blockquote className="text-lg text-gray-400 grow">— どこよりも成果を実感できました。初めて勉強方法を教えてもらえた</blockquote>
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Anastasia Dan</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">UX Board</a>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="400">
              ...
              <blockquote className="text-lg text-gray-400 grow">— 子供にあった勉強方法、声掛けをしてくれる。目的意識を持って自ら勉強に取り組むようになった。</blockquote>
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Anastasia Dan</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">UX Board</a>
              </div>
            </div>
